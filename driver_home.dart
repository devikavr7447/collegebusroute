...
class _DriverHomeScreenState extends State<DriverHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Welcome $_driverId", style: TextStyle(color: Colors.black)),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Image.asset('assets/bus_image.png', height: 150), // Bus Image at the Top
            SizedBox(height: 10),
                ...
                child: Column(
                  children: [
                    TextField(
                      ...
                      decoration: InputDecoration(labelText: "Enter Delay Reason", border: OutlineInputBorder()),
                    ),
                    SizedBox(height: 10),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {}, // Functionality to send delay message
                          child: Text(
                            "Send Delay Message",
